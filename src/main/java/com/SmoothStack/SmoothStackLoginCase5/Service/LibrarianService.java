...
public class LibrarianService {
	...
	public ResponseEntity<String> librarianMenu(){
		return ResponseEntity.ok().body("1) Update Library Branch" 
	...
	public ResponseEntity<BookCopy> updateBookCopies(@PathVariable(value = "bookId") int bookId,
							@PathVariable(value = "branchId") int libraryBranchId,
		...
		bookCopy.setLibraryBranch(bookCopyDetails.getLibraryBranch());
